...
library BitFlagsLib {
    /// @notice Checks whether the bitflag for a mint being an open edition is toggled
    ...
    /// @notice Checks whether the bitflag for enforcing a supply cap is toggled
    /// @param self The bitflags to check
    ...
    /// @notice Checks whether the bitflag for public mint is toggled
    /// @param self The bitflags to check
    ...
    /// @notice Checks whether the bitflag for mint from allowlist is toggled
    /// @param self The bitflags to check
    ...
    /// @notice Checks whether the bitflag for mint with pass is toggled
    /// @param self The bitflags to check
    ...
    /// @notice Checks whether the bitflag for mint tickets is toggled
    /// @param self The bitflags to check
    ...
    /// @notice Checks whether the bitflag for refundable is toggled
    /// @param self The bitflags to check
