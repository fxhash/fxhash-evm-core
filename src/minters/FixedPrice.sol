...
contract FixedPrice is IFixedPrice, Allowlist, MintPass, Ownable, Pausable {
     ...
     */
    mapping(address => uint40) internal latestUpdates;
     ...
     */
    mapping(address => uint128) internal saleProceeds;
