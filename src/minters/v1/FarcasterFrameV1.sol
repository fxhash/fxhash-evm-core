...
import {IFarcasterFrameV1} from "src/interfaces/v1/IFarcasterFrameV1.sol";
...
/**
 * @title FarcasterFrameV1
 * @author fx(hash)
 * @dev See the documentation in {IFarcasterFrameV1}
 */
contract FarcasterFrameV1 is IFarcasterFrameV1, Ownable, Pausable {
