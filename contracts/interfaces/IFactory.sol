...
/**
 * @title IFactory
 * @notice Interface for the factories used by the FxHash Factory. Contains the 
 * methods to manage the factory configuration: set the authorized factory 
 * caller, and the implementation contract
 */
interface IFactory {
